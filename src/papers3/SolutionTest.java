...
public class SolutionTest {
	...
	public void day27thTest() {
		...
		ivanka.put("passport", "NATION: Arstotzka\r\n" + 
				"DOB: 1919.06.14\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Great Rapid\r\n" + 
				"ID#: PJ2F1-NUY44\r\n" + 
				"EXP: 1984.12.27\r\n" + 
				"NAME: Latva, Beatrix");
		ivanka.put("access_permit", "NAME: Latva, Beatrix\r\n" + 
				"NATION: Arstotzka\r\n" + 
				"ID#: OJ6QH-T51IQ\r\n" + 
				"PURPOSE: TRANSIT\r\n" + 
				"DURATION: 2 DAYS\r\n" + 
		...
		assertEquals("Detainment: ID number mismatch.", inspector.inspect(ivanka));
		...
		inspector.receiveBulletin(
				...
				"Wanted by the State: Freja Crechiolo");
...
*/
	/*	inspector.receiveBulletin("Citizens of Arstotzka require ID card\r\n" + 
				...
				"Citizens of Antegria, Impor, Kolechia require yellow fever vaccination\r\n" + 
				"Wanted by the State: Potr Zeitsoff1");
		
		Map<String, String> pyotr = new HashMap<String, String>();
		pyotr.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1917.01.26\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Skal\r\n" + 
				"ID#: TQWIK-LLFEA\r\n" + 
				"EXP: 1984.10.01\r\n" + 
				"NAME: Zeitsoff, Pyotr");
		pyotr.put("grant_of_asylum", "NAME: Zeitsoff, Pyotr\r\n" + 
				"NATION: Impor\r\n" + 
				"ID#: TQWIK-LLFEA\r\n" + 
				"DOB: 1917.01.26\r\n" + 
				"HEIGHT: 185.0cm\r\n" + 
				"WEIGHT: 98.0kg\r\n" + 
				"EXP: 1986.12.29");
		pyotr.put("certificate_of_vaccination", "NAME: Zeitsoff, Pyotr\r\n" + 
				"ID#: TQWIK-LLFEA\r\n" + 
				"VACCINES: polio, cholera, tetanus");

		assertEquals("Entry denied: missing required vaccination.", inspector.inspect(pyotr));
	
		Map<String, String> yuri =  new HashMap<String, String>();
		yuri.put("work_pass", "NAME: Carlstrom, Yuri\r\n" + 
				"FIELD: Statistics\r\n" + 
				"EXP: 1983.10.11");
		yuri.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1931.05.26\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Haihan\r\n" + 
				"ID#: OOJC3-QGH3F\r\n" + 
				"EXP: 1981.11.10\r\n" + 
				"NAME: Carlstrom, Yuri");
		yuri.put("access_permit", "NAME: Carlstrom, Yuri\r\n" + 
				"NATION: Impor\r\n" + 
				"ID#: HUUR4-W54LI\r\n" + 
				"PURPOSE: WORK\r\n" + 
				"DURATION: 3 MONTHS\r\n" + 
				...
				"WEIGHT: 95.0kg\r\n" + 
				"EXP: 1983.04.24");
		yuri.put("certificate_of_vaccination", "NAME: Carlstrom, Yuri\r\n" + 
				"ID#: OOJC3-QGH3F\r\n" + 
				"VACCINES: tetanus, hepatitis B, HPV, yellow fever");
		
		assertEquals("Detainment: ID number mismatch.", inspector.inspect(yuri));
		*/
		inspector.receiveBulletin("Deny citizens of Kolechia\r\n" + 
				"Foreigners require HPV vaccination\r\n" + 
				"Wanted by the State: Aaron Shaw");
		Map<String, String> nicolai = new HashMap<String, String>();
		nicolai.put("passport", "NATION: Republia\r\n" + 
				"DOB: 1920.03.27\r\n" + 
				"SEX: M\r\n" + 
				"ISS: True Glorian\r\n" + 
				"ID#: I1NSX-E2C7V\r\n" + 
				"EXP: 1985.06.27\r\n" + 
				"NAME: Novak, Nicolai");
		nicolai.put("access_permit", "NAME: Novak, Nicolai\r\n" + 
				"NATION: Republia\r\n" + 
				"ID#: I1NSX-E2C7V\r\n" + 
				"PURPOSE: VISIT\r\n" + 
				"DURATION: 3 MONTHS\r\n" + 
				...
				"WEIGHT: 59.0kg\r\n" + 
				"EXP: 1985.09.07");
	/*	nicolai.put("certificate_of_vaccination", "NAME: Novak, Nicolai\r\n" + 
				"ID#: I1NSX-E2C7V\r\n" + 
				"VACCINES: polio, tetanus, yellow fever");
		*/
		assertEquals("Entry denied: missing required certificate of vaccination.", inspector.inspect(nicolai));
		
		
		inspector.receiveBulletin("Citizens of Arstotzka require ID card\r\n" + 
				"Deny citizens of United Federation\r\n" + 
				"Entrants require tetanus vaccination\r\n" + 
				"Wanted by the State: Ingrid Hammacher");
		
		Map<String,String> josefina = new HashMap<String, String>();
		josefina.put("passport", "NATION: Impor\r\n" + 
				...
				"EXP: 1983.01.19\r\n" + 
				"NAME: Tjell, Josefina");
		josefina.put("access_permit", "NAME: Tjell, Josefina\r\n" + 
				"NATION: Kolechia\r\n" + 
				"ID#: PJNZ6-PM258\r\n" + 
				"PURPOSE: IMMIGRATE\r\n" + 
				"DURATION: FOREVER\r\n" + 
				...
				"WEIGHT: 90.0kg\r\n" + 
				"EXP: 1985.05.11");
		 assertEquals("Detainment: nationality mismatch.", inspector.inspect(josefina));

		 
		 inspector.receiveBulletin("Allow citizens of Impor\r\n" + 
		 		"Deny citizens of United Federation\r\n" + 
		 		"Citizens of Obristan no longer require tetanus vaccination\r\n" + 
		 		"Entrants require polio vaccination\r\n" + 
		 		"Wanted by the State: Gabrielle Weiss");
		 
		 Map<String, String> martin = new HashMap<String, String>();
		 martin.put("passport", "NATION: Obristan\r\n" + 
		 		"DOB: 1934.07.05\r\n" + 
		 		"SEX: M\r\n" + 
		 		"ISS: Mergerous\r\n" + 
		 		"ID#: QFVOX-YNIZ8\r\n" + 
		 		"EXP: 1983.09.21\r\n" + 
		 		"NAME: Wolfe, Martin");
		/* martin.put("grant_of_asylum", "NAME: Wolfe, Martin\r\n" + 
		 		"NATION: Obristan\r\n" + 
		 		"ID#: QFVOX-YNIZ8\r\n" + 
		 		"DOB: 1934.07.05\r\n" + 
		 		"HEIGHT: 156.0cm\r\n" + 
		 		"WEIGHT: 56.0kg\r\n" + 
		 		"EXP: 1984.04.30");*/
		 martin.put("certificate_of_vaccination", "NAME: Wolfe, Martin\r\n" + 
		 		"ID#: QFVOX-YNIZ8\r\n" + 
		 		"VACCINES: HPV, typhus");
		 
		 assertEquals("Entry denied: missing required vaccination.", inspector.inspect(martin));
		 
		 inspector.receiveBulletin("Allow citizens of Obristan\r\n" + 
		 		"Deny citizens of Kolechia\r\n" + 
		 		"Citizens of Antegria, Impor no longer require tetanus vaccination\r\n" + 
		 		"Foreigners require HPV vaccination\r\n" + 
		 		"Wanted by the State: Simon Grech");
	}
	...
	public void day28th() {
		...
		inspector.receiveBulletin("Entrants require passport\r\n" + 
				"Allow citizens of Arstotzka\r\n" + 
				"Wanted by the State: Omid Lindberg");
		
		Map<String, String> a = new HashMap<>();
		a.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1955.04.07\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Tsunkeido\r\n" + 
				"ID#: Q7246-CSTCD\r\n" + 
		...
		inspector.receiveBulletin("Allow citizens of Antegria, Impor, Kolechia, Obristan, Republia, United Federation\r\n" + 
				"Wanted by the State: Michelle Owsianka");
		
		Map<String, String> b = new HashMap<>();
		b.put("passport", "NATION: Obristan\r\n" + 
				"DOB: 1921.11.26\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Skal\r\n" + 
				"ID#: HIJ0C-W824T\r\n" + 
				"EXP: 1983.12.26\r\n" + 
				"NAME: Owsianka, Michelle");
		
		inspector.receiveBulletin("Foreigners require access permit\r\n" + 
				"Wanted by the State: Christina Reed");
		
		Map<String, String> c = new HashMap<>();
		c.put("passport", "NATION: Obristan\r\n" + 
				"DOB: 1935.10.30\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Lorndaz\r\n" + 
				"ID#: VLOGR-Q9AC0\r\n" + 
				"EXP: 1983.04.28\r\n" + 
				"NAME: Krug, Cesar");
		c.put("grant_of_asylum", "NAME: Krug, Cesar\r\n" + 
				"NATION: Obristan\r\n" + 
				"ID#: VLOGR-Q9AC0\r\n" + 
				"DOB: 1935.10.30\r\n" + 
				"HEIGHT: 188.0cm\r\n" + 
		...
		inspector.receiveBulletin("Citizens of Arstotzka require ID card\r\n" + 
				"Deny citizens of Obristan\r\n" + 
				"Wanted by the State: Dominik Tolaj");
		
		Map<String, String> d = new HashMap<>();
		d.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1940.11.12\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Tsunkeido\r\n" + 
				"ID#: V6XHW-RP963\r\n" + 
				"EXP: 1983.01.29\r\n" + 
				"NAME: Romanov, Olec");
		d.put("access_permit", "NAME: Romanov, Olec\r\n" + 
				"NATION: Impor\r\n" + 
				"ID#: V6XHW-RP963\r\n" + 
				"PURPOSE: VISIT\r\n" + 
				"DURATION: 3 MONTHS\r\n" + 
		...
		inspector.receiveBulletin("Deny citizens of Obristan\r\n" + 
				"Entrants require tetanus vaccination\r\n" + 
				"Wanted by the State: Freja Crechiolo");
		
		Map<String, String> e= new HashMap<>();
		e.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1919.09.11\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Tsunkeido\r\n" + 
				"ID#: FCCR6-KT7IQ\r\n" + 
				"EXP: 1984.07.07\r\n" + 
				"NAME: Crechiolo, Freja");
		e.put("access_permit", "NAME: Crechiolo, Freja\r\n" + 
				"NATION: Kolechia\r\n" + 
				"ID#: FCCR6-KT7IQ\r\n" + 
				"PURPOSE: VISIT\r\n" + 
				"DURATION: 2 MONTHS\r\n" + 
				...
				"WEIGHT: 74.0kg\r\n" + 
				"EXP: 1984.03.18");
		e.put("certificate_of_vaccination", "NAME: Crechiolo, Freja\r\n" + 
				"ID#: FCCR6-KT7IQ\r\n" + 
				"VACCINES: tetanus, polio, tuberculosis");
		
		inspector.receiveBulletin("Allow citizens of Obristan\r\n" + 
				"Deny citizens of Kolechia\r\n" + 
				"Wanted by the State: Julia Lang");
		
		Map<String, String> f= new HashMap<>();
		f.put("access_permit", "NAME: Bennet, Jonathan\r\n" + 
				"NATION: Kolechia\r\n" + 
				"ID#: CDMAL-BJ84D\r\n" + 
				"PURPOSE: TRANSIT\r\n" + 
				"DURATION: 14 DAYS\r\n" + 
				...
				"WEIGHT: 53.0kg\r\n" + 
				"EXP: 1985.06.26");
		f.put("certificate_of_vaccination", "NAME: Bennet, Jonathan\r\n" + 
				"ID#: CDMAL-BJ84D\r\n" + 
				"VACCINES: typhus, hepatitis B, cowpox");
		
		assertEquals("Entry denied: missing required passport.", inspector.inspect(f));
		
		Map<String, String> g= new HashMap<>();
		g.put("passport", "NATION: Kolechia\r\n" + 
				"DOB: 1916.10.19\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Yurko City\r\n" + 
				"ID#: TD1UQ-A85C9\r\n" + 
				"EXP: 1985.10.08\r\n" + 
				"NAME: Hammerstein, Niel");
		g.put("access_permit", "NAME: Hammerstein, Niel\r\n" + 
				"NATION: Kolechia\r\n" + 
				"ID#: TD1UQ-A85C9\r\n" + 
				"PURPOSE: TRANSIT\r\n" + 
				"DURATION: 2 DAYS\r\n" + 
		...
		assertEquals("Entry denied: missing required certificate of vaccination.", inspector.inspect(g));
		
		inspector.receiveBulletin("Allow citizens of United Federation\r\n" + 
				"Deny citizens of Obristan\r\n" + 
				"Wanted by the State: Ibrahim Lewandowski");
		Map<String, String> h = new HashMap<String, String>();
		h.put("ID_card", "NAME: Kierkgaard, Gustav\r\n" + 
				"DOB: 1943.04.25\r\n" + 
				"HEIGHT: 171.0cm\r\n" + 
				"WEIGHT: 77.0kg");
		
		assertEquals("Entry denied: missing required passport.", inspector.inspect(h));
		
		Map<String, String> i = new HashMap<String, String>();
		i.put("passport", "NATION: United Federation\r\n" + 
				"DOB: 1920.06.06\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Mergerous\r\n" + 
				"ID#: SAF1H-SR39V\r\n" + 
				"EXP: 1984.04.15\r\n" + 
				"NAME: Hertzog, Ilya");
		i.put("certificate_of_vaccination", "NAME: Hertzog, Ilya\r\n" + 
				"ID#: SAF1H-SR39V\r\n" + 
				"VACCINES: polio, typhus, rubella");
		i.put("diplomatic_authorization", "NATION: United Federation\r\n" + 
				"NAME: Hertzog, Ilya\r\n" + 
				"ID#: SAF1H-SR39V\r\n" + 
				"ACCESS: Arstotzka, Obristan");
		
		assertEquals("Entry denied: missing required vaccination.", inspector.inspect(i));
		
		Map<String, String> j = new HashMap<String, String>();
		j.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1951.01.28\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Enkyo\r\n" + 
				"ID#: T6C4U-TSEXV\r\n" + 
				"EXP: 1985.01.15\r\n" + 
				"NAME: Schneider, Kamala");
		j.put("certificate_of_vaccination", "NAME: Schneider, Kamala\r\n" + 
				"ID#: T6C4U-TSEXV\r\n" + 
				"VACCINES: HPV, cowpox, tuberculosis");
		 assertEquals("Entry denied: missing required access permit.", inspector.inspect(j));
		 
		 inspector.receiveBulletin("Foreigners require typhus vaccination\r\n");
		 inspector.receiveBulletin("Allow citizens of Obristan\r\n" + 
		 		"Deny citizens of Kolechia\r\n" + 
		 		"Foreigners no longer require typhus vaccination\r\n" + 
		 		"Entrants require polio vaccination\r\n" + 
		 		"Wanted by the State: Eduardo Mateo");
		 Map<String, String> k = new HashMap<String, String>();
		 k.put("passport", "NATION: Impor\r\n" + 
		 		"DOB: 1926.02.14\r\n" + 
		 		"SEX: F\r\n" + 
		 		"ISS: Tsunkeido\r\n" + 
		 		"ID#: XFL1K-S5EWE\r\n" + 
		 		"EXP: 1985.03.29\r\n" + 
		 		"NAME: Spektor, Agnes");
		 k.put("access_permit", "NAME: Spektor, Agnes\r\n" + 
		 		"NATION: Impor\r\n" + 
		 		"ID#: XFL1K-S5EWE\r\n" + 
		 		"PURPOSE: TRANSIT\r\n" + 
		 		"DURATION: 2 DAYS\r\n" + 
		 		...
		 		"WEIGHT: 102.0kg\r\n" + 
		 		"EXP: 1984.04.06");
		 k.put("certificate_of_vaccination", "NAME: Spektor, Agnes\r\n" + 
		 		"ID#: XFL1K-S5EWE\r\n" + 
		 		"VACCINES: polio, tuberculosis, HPV, tetanus\r\n");
		 
		 assertEquals("Cause no trouble.", inspector.inspect(k));
	}
	...
	public void dec5th() {
		...
		inspector.receiveBulletin("Citizens of Arstotzka require ID card\r\n" + 
				...
				"Foreigners require HPV vaccination");
		inspector.receiveBulletin("Deny citizens of Antegria");
		inspector.receiveBulletin("Allow citizens of Antegria\r\n" + 
				"Deny citizens of Kolechia");
		inspector.receiveBulletin("Allow citizens of Kolechia\r\n" + 
				"Deny citizens of United Federation");
		inspector.receiveBulletin("Allow citizens of United Federation\r\n" + 
				"Deny citizens of Kolechia");
		inspector.receiveBulletin("Allow citizens of Kolechia\r\n" + 
				"Deny citizens of Obristan\r\n" + 
				"Foreigners no longer require HPV vaccination\r\n" + 
				"Citizens of Antegria, Impor, United Federation, Kolechia require polio vaccination");
		inspector.receiveBulletin("Allow citizens of Obristan\r\n" + 
				"Deny citizens of Republia\r\n" + 
				"Workers require work pass");
		inspector.receiveBulletin("Allow citizens of Republia\r\n" + 
				"Deny citizens of Antegria");
		inspector.receiveBulletin("Allow citizens of Antegria\r\n" + 
				"Deny citizens of Kolechia");
		inspector.receiveBulletin("Allow citizens of Kolechia\r\n" + 
		...
		a.put("passport", "NATION: United Federation\r\n" + 
				"DOB: 1942.03.09\r\n" + 
				"SEX: M\r\n" + 
				"ISS: Shingleton\r\n" + 
				"ID#: MY3T7-FJWRD\r\n" + 
				"EXP: 1985.12.14\r\n" + 
				"NAME: Karnov, Luis");
		a.put("diplomatic_authorization", "NATION: United Federation\r\n" + 
				"NAME: Karnov, Luis\r\n" + 
				"ID#: MY3T7-FJWRD\r\n" + 
				"ACCESS: Arstotzka, Impor, United Federation, Republia");
		
		assertEquals("Entry denied: missing required certificate of vaccination.", inspector.inspect(a));
		
		Map<String, String> b = new HashMap<String, String>();
		b.put("passport", "NATION: Impor\r\n" + 
				"DOB: 1914.12.03\r\n" + 
				"SEX: F\r\n" + 
				"ISS: Tsunkeido\r\n" + 
				"ID#: NDAHD-MEF8N\r\n" + 
				"EXP: 1984.07.17\r\n" + 
				"NAME: Bergman, Karina");
		b.put("access_permit", "NAME: Bergman, Karina\r\n" + 
				"NATION: Impor\r\n" + 
				"ID#: NDAHD-MEF8N\r\n" + 
				"PURPOSE: WORK\r\n" + 
				"DURATION: 2 MONTHS\r\n" + 
				...
				"WEIGHT: 64.0kg\r\n" + 
				"EXP: 1985.06.29");
		b.put("certificate_of_vaccination", "NAME: Bergman, Karina\r\n" + 
				"ID#: NDAHD-MEF8N\r\n" + 
				"VACCINES: polio, HPV, cowpox");
		
		assertEquals("Entry denied: missing required work pass.", inspector.inspect(b));
		...
		c.put("passport", "NATION: Obristan\r\n" + 
				...
				"EXP: 1985.10.15\r\n" + 
				"NAME: Lovska, Rafal");
		c.put("grant_of_asylum", "NAME: Lovska, Rafal\r\n" + 
				"NATION: Obristan\r\n" + 
				"ID#: PPNB0-DU0TE\r\n" + 
				"DOB: 1953.10.07\r\n" + 
				"HEIGHT: 151.0cm\r\n" + 
				"WEIGHT: 49.0kg\r\n" + 
				"EXP: 1981.12.03");
		c.put("certificate_of_vaccination", "NAME: Lovska, Rafal\r\n" + 
				"ID#: PPNB0-DU0TE\r\n" + 
				"VACCINES: tetanus, polio, HPV, copvox");
		
		assertEquals("Entry denied: grant of asylum expired.", inspector.inspect(c));
	}
